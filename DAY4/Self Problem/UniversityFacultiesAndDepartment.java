...
class University {
    ...
    public void getUniversityDetails() {
        System.out.println("University name is " + universityName + " annd it has " + numberOfDepartment + " of departments. Detail of each department is: ");

        for(Department department : departments) {
            System.out.println("Department name is " + department.depName + " and it has " + department.faculties + " and it's details are: ");
