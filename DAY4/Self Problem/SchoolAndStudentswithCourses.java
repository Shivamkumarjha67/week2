...
public class SchoolAndStudentswithCourses {
    public static void main(String[] args) {
        ...
        School dav = new School("DAV", 1889);

        // Declaring the multiple student objects
        Student student1 = new Student("Raju", 20);
        Student student2 = new Student("Paju", 22);
        Student student3 = new Student("shiv", 21);

        // Adding the student to the school record
        dav.addStudent(student1);
        dav.addStudent(student2);
        dav.addStudent(student3);

        // Displaying the all student record in the school
        dav.allSudentsInSchool();
